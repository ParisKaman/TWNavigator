...
namespace Microsoft.Azure.SpatialAnchors.Unity.ARFoundation
{
    internal static class AnchorHelpers
    {
        ...
        /// <returns>An ARFoundation <see cref="ARAnchor"/>.</returns>
        ...
        /// <summary>
        /// Creates an ARAnchor from the specified <see cref="Transform"/>.
        /// </summary>
        ...
        private static Pose GetPose(IntPtr anchorPointer)
        {
            ...
            ARAnchor referencePoint = SpatialAnchorManager.AnchorFromPointer(anchorPointer);
